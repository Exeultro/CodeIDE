import { a as MarkerSeverity, c as Range, f as Uri, h as languages, o as MarkerTag, p as editor } from "./editor.api2-BKXKzRzT.js";
import "./toggleHighContrast-BDDDYsSx.js";
import { n as typescriptDefaults } from "./monaco.contribution-BEbq99o2.js";
	...
	_getClient() {
		if (!this._client) this._client = (async () => {
			this._worker = createWebWorker({
				...
				createWorker: () => new Worker(new URL("../../monaco-editor/esm/vs/language/typescript/ts.worker.js", import.meta.url), { type: "module" }),
				label: this._modeId,
				keepIdleModels: true,
				createData: {
...
//# sourceMappingURL=tsMode-DNbOAEvG.js.map