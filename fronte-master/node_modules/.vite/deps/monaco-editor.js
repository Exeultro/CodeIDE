import { Zd as __exportAll, a as MarkerSeverity, c as Range, d as Token, f as Uri, h as languages, i as KeyMod, l as Selection, n as Emitter, o as MarkerTag, p as editor, r as KeyCode, s as Position, t as CancellationTokenSource, u as SelectionDirection } from "./editor.api2-BKXKzRzT.js";
import "./toggleHighContrast-BDDDYsSx.js";
import { t as monaco_contribution_exports$3 } from "./monaco.contribution-BEbq99o2.js";
import { t as createWebWorker } from "./workers-BKbxV9Te.js";
import { t as getGlobalMonaco } from "./initialize-Bstw8B9K.js";
import "D:/razumtwo/fronte-master/node_modules/monaco-editor/esm/vs/base/browser/ui/codicons/codicon/codicon.css";
import "D:/razumtwo/fronte-master/node_modules/monaco-editor/esm/vs/base/browser/ui/codicons/codicon/codicon-modifiers.css";
...
function getMode$2() {
	return import("./cssMode-BRTMCR2N.js");
}
...
function getMode$1() {
	return import("./htmlMode-EZc4Ov66.js");
}
...
function getMode() {
	return import("./jsonMode-U9YDJSDo.js");
}
languages.register({
	id: "json",
	extensions: [
...
registerLanguage({
	...
	extensions: [".abap"],
	aliases: ["abap", "ABAP"],
	loader: () => import("./abap-BeW5l7-z.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./apex-CW55-akX.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./azcli-CbDq0kte.js")
});
//#endregion
...
registerLanguage({
	...
	extensions: [".bicep"],
	aliases: ["Bicep"],
	loader: () => import("./bicep-DMZEWLvk.js")
});
//#endregion
...
registerLanguage({
	...
	extensions: [".mligo"],
	aliases: ["Cameligo"],
	loader: () => import("./cameligo-DKcTu5gC.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./clojure-CWB2D6mg.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./coffee-DqJeorkB.js")
});
//#endregion
...
registerLanguage({
	...
	aliases: ["C#", "csharp"],
	loader: () => import("./csharp-ChffVU74.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./cypher-bORGCDPO.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./dart-B3LOQhM3.js")
});
//#endregion
...
registerLanguage({
	...
	aliases: ["Dockerfile"],
	loader: () => import("./dockerfile-DSIxx0TU.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./elixir-Y8kBexyq.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./flow9-B9gIA3sm.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./fsharp-ekeyo-lW.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => {
		return import("./freemarker2-BNdO59Qx.js").then((m) => m.TagAutoInterpolationDollar);
	}
});
registerLanguage({
	...
	loader: () => {
		return import("./freemarker2-BNdO59Qx.js").then((m) => m.TagAngleInterpolationDollar);
	}
});
registerLanguage({
	...
	loader: () => {
		return import("./freemarker2-BNdO59Qx.js").then((m) => m.TagBracketInterpolationDollar);
	}
});
registerLanguage({
	...
	loader: () => {
		return import("./freemarker2-BNdO59Qx.js").then((m) => m.TagAngleInterpolationBracket);
	}
});
registerLanguage({
	...
	loader: () => {
		return import("./freemarker2-BNdO59Qx.js").then((m) => m.TagBracketInterpolationBracket);
	}
});
registerLanguage({
...
registerLanguage({
	...
	loader: () => {
		return import("./freemarker2-BNdO59Qx.js").then((m) => m.TagAutoInterpolationBracket);
	}
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./graphql-Co1bncUi.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./handlebars-DRe2_hDM.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./html-CdMNl1fw.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./java-qcPBeso1.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./javascript-DXrdDGBK.js")
});
//#endregion
...
registerLanguage({
	...
	extensions: [".jl"],
	aliases: ["julia", "Julia"],
	loader: () => import("./julia-DOQ4wrDb.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./kotlin-BU0s7fDz.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./less-BUuQPJyO.js")
});
//#endregion
...
registerLanguage({
	...
	extensions: [".lex"],
	aliases: ["Lexon"],
	loader: () => import("./lexon-CFkYAxz0.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./liquid-Bxo_OyLx.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./markdown-CGJOFWZF.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./mips-CBNaWhh8.js")
});
//#endregion
...
registerLanguage({
	...
	aliases: ["DAX", "MSDAX"],
	loader: () => import("./msdax-DPLUxfPw.js")
});
//#endregion
...
registerLanguage({
	...
	extensions: [],
	aliases: ["MySQL", "mysql"],
	loader: () => import("./mysql-BuiFeb1o.js")
});
//#endregion
...
registerLanguage({
	...
	extensions: [".m"],
	aliases: ["Objective-C"],
	loader: () => import("./objective-c-CIsJFV8-.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./pascal-DO70Ikrc.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./pascaligo-C1-bMtAT.js")
});
//#endregion
...
registerLanguage({
	...
	extensions: [".pl", ".pm"],
	aliases: ["Perl", "pl"],
	loader: () => import("./perl-aoGI156i.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./pgsql-Bqf73w3A.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./postiats-CSAHtES3.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./powerquery-CM4AIQoQ.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./powershell-DP5y8GUa.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./protobuf-BxSr8tYJ.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./python-C2dHK9yj.js")
});
//#endregion
...
registerLanguage({
	...
	extensions: [".qs"],
	aliases: ["Q#", "qsharp"],
	loader: () => import("./qsharp-Dtk91Gfk.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./razor-BfUKZ3oQ.js")
});
//#endregion
...
registerLanguage({
	...
	extensions: [".redis"],
	aliases: ["redis"],
	loader: () => import("./redis-DxodqDye.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./redshift-BFLWIhiA.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./restructuredtext-N1gvWir2.js")
});
//#endregion
...
registerLanguage({
	...
	aliases: ["Ruby", "rb"],
	loader: () => import("./ruby-D5eFYnme.js")
});
//#endregion
...
registerLanguage({
	...
	extensions: [".rs", ".rlib"],
	aliases: ["Rust", "rust"],
	loader: () => import("./rust-CC4Kjbv8.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./scala-nWmhhA6c.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./scheme-DTXTCb2r.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./scss-C7XjlW9b.js")
});
//#endregion
...
registerLanguage({
	...
	extensions: [".sh", ".bash"],
	aliases: ["Shell", "sh"],
	loader: () => import("./shell-CWoiB1vf.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./solidity-DAYINgQy.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./sophia-DxtPfl9e.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./sparql-CYeD-fiH.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./swift-CkS7O8Yd.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./systemverilog-DrfhrCtF.js")
});
registerLanguage({
	id: "verilog",
	extensions: [".v", ".vh"],
...
registerLanguage({
	...
	loader: () => import("./twig-CeLhK-jj.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => {
		return import("./typescript-CeMxkhHO.js");
	}
});
//#endregion
...
registerLanguage({
	...
	extensions: [".tsp"],
	aliases: ["TypeSpec"],
	loader: () => import("./typespec-D39M88U7.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./wgsl-B4W57OYG.js")
});
//#endregion
...
var ConsoleMessageLogger = class {
	log(stream, type, message) {
		console.log(`${type === "incoming" ? "<-" : "->"} [${stream.toString()}] ${JSON.stringify(message)}`);
	}
};
...
//#endregion
export { CancellationTokenSource, Emitter, KeyCode, KeyMod, MarkerSeverity, MarkerTag, Position, Range, Selection, SelectionDirection, Token, Uri, createWebWorker, monaco_contribution_exports as css, editor, monaco_contribution_exports$1 as html, monaco_contribution_exports$2 as json, languages, out_exports as lsp, monaco_contribution_exports$3 as typescript };
