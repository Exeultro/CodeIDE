import { c as Range, l as Selection, u as SelectionDirection } from "./editor.api2-BKXKzRzT.js";
import "./initialize-Bstw8B9K.js";
import { $ as createRelativePositionFromTypeIndex, q as createAbsolutePositionFromRelativePosition, un as unexpectedCase } from "./yjs-40LSHSru.js";
import "./awareness-BaNUkq79.js";
...
//#endregion
//#region node_modules/y-monaco/src/y-monaco.js
...
var createRelativeSelection = (editor, monacoModel, type) => {
	...
	if (sel !== null) {
		...
		return new RelativeSelection(createRelativePositionFromTypeIndex(type, monacoModel.getOffsetAt(startPos)), createRelativePositionFromTypeIndex(type, monacoModel.getOffsetAt(endPos)), sel.getDirection());
	}
	return null;
};
/**
		...
		*/
		...
		this._rerenderDecorations = () => {
			editors.forEach((editor) => {
				...
				} else this._decorations.delete(editor);
			});
		};
		/**
		...
		this._ytextObserver = (event) => {
			this.mux(() => {
				...
				event.delta.forEach((op) => {
					if (op.retain !== void 0) index += op.retain;
