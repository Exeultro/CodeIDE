import { h as languages } from "./editor.api2-BKXKzRzT.js";
	...
	_getClient() {
		...
		if (!this._client) {
			this._worker = createWebWorker({
				...
				createWorker: () => new Worker(new URL("../../monaco-editor/esm/vs/language/html/html.worker.js", import.meta.url), { type: "module" }),
				createData: {
...
//# sourceMappingURL=htmlMode-EZc4Ov66.js.map