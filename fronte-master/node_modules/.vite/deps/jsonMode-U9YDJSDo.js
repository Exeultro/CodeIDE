	...
	_getClient() {
		...
		if (!this._client) {
			this._worker = createWebWorker({
				...
				createWorker: () => new Worker(new URL("../../monaco-editor/esm/vs/language/json/json.worker.js", import.meta.url), { type: "module" }),
...
//# sourceMappingURL=jsonMode-U9YDJSDo.js.map